...
import { TransformProcessor } from '@src/model/ring/4/index.js';
...
describe('Ring 4 Integration', () => {
    it('should export TransformProcessor from index', async () => {
        const exports = await import('@src/model/ring/4/index.js');
...
describe('Transform proof', () => {
    it('should normalize user input before database storage', async () => {
        const { TransformProcessor } = await import('@src/model/ring/4/index.js');
