 ...
 * VFS Bootstrap
 *
 * Contains the process library source code that gets written to /lib/process.ts
 * during kernel boot. This enables VFS scripts to make syscalls.
 */

/**
 * Source code for /lib/process.ts
 *
 * This is a self-contained version of the process library that works
 * inside VFS-spawned Workers. It includes:
 * - Syscall transport
 * - Error handling
 * - All syscall wrappers
 */
export const PROCESS_LIB_SOURCE = `/**
 * Process Library for VFS Scripts
 *
 * Provides syscall wrappers for VFS-based scripts.
 * This module is auto-generated during kernel boot.
 */
